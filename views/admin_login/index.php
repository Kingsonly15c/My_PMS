      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form method="POST" action="admin_login/login">
              <h1>Admin Login</h1>
              <div>
              ...
              <div class="separator">
                <p class="change_link">
                  <a href="<?php echo URL?>index" class="to_register"> Back To Home </a>
                </p>
                ...
                <div>
                  <h1><i class="fa fa-home"></i> DBI Guest House</h1>
                  <p>©<?php echo date('Y'); ?> All Rights Reserved. DBI Guest House. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
          ...
          <section class="login_content">
            <form>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> DBI Guest House</h1>
                  <p>©<?php echo date('Y'); ?> All Rights Reserved. DBI Guest House. Privacy and Terms</p>
                </div>
              </div>
            </form>
